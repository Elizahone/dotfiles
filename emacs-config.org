...
** Themes
#+begin_src emacs-lisp :tangle ~/.emacs.d/init.el
  (set-face-attribute 'default nil :font (font-spec :family "Source Code Pro" :size 24))
  (set-fontset-font t 'unicode (font-spec :family "STKaiti" :size 26))
  ...
  (use-package doom-themes
    ...
    :init (load-theme 'doom-tokyo-night nil))
